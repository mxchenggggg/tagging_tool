...
for image in images_file_list:
    ...
    img_ind += 1
    image.GetContentFile(os.path.join('/media/ac12/Data/tagging_tool/images' ,image['title']))
...
for label in labels_file_list:
    ...
    label_ind += 1
    label.GetContentFile(os.path.join('/media/ac12/Data/tagging_tool/labels' ,label['title']))
